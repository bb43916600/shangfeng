...
public class AuthCodeServlet extends HttpServlet {
	...
	private static final long serialVersionUID = 5452247894914087695L;
	...
	private BufferedImage code1(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	...
	private BufferedImage code2(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		Height=24;
		Width=60;
	...
	private BufferedImage code3(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		this.image = new BufferedImage(this.Width, this.Height, 1);
