            ...
            <div class="right">
            	<div class="curr">
            		<c:if test="${object.type eq 2 }">
	                	...
	                	<h2>风机产业<i>Magnet wire industry</i></h2>
                	</c:if>
                ...
                <div class="content">
                	<div class="industry" style="color:#595959; padding-bottom:0">
            	...
            	<div class="left">
                    ...
                    <div class="sub_m">
                   	  <ul class="sublist">
                        	<li <c:if test="${object.type eq 1 }">class="hover" </c:if>><a href="javascript:;">电磁线产业</a>
                            <div class="subbox">
                            	<ul class="sub2list">
                            ...
                            <li <c:if test="${object.type eq 2 }">class="hover" </c:if>><a href="javascript:;">风机产业</a>
                            <div class="subbox">
                            	<ul class="sub2list">
