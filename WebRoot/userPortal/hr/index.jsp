...
<body>
    ...
    <div class="bg_c">
           ...
           <div class="nban">
            ...
            <div class="right">
            	<div class="curr">
                	<span><a href="${ctx }/userportal/wapIndex.action" class="home">首页</a> > <i>人才理念</i></span><h2>人才理念<i>Talent Concept</i></h2>
                </div>
                <div class="content">
                	<div class="about hr">
                    	${object.content} 
            	...
            	<div class="left">
                    ...
                    <div class="sub_m">
                   	  <ul class="sublist">
                        	<li class="hover"><a href="${ctx }/userportal/wapConcept.action">人才理念</a></li>
