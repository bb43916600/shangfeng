...
<body>
    ...
    <div class="bg_c">
           ...
           <div class="nban">
            ...
            <div class="right">
            	<div class="curr">
                	<span><a href="${ctx }/userportal/wapIndex.action" class="home">首页</a> > <i class="i">各经营基地</i> > <i>浙江上风实业股份有限公司</i></span><h2>各经营基地<i>Each operating base</i></h2>
                </div>
                <div class="content">
                	<div class="contact2">
                		${object.content }
                            ...
                            <div class="subbox">
                            	<ul class="sub2list">
                            		<c:forEach items="${list }" var="objects">
                            			<li <c:if test="${objects.id eq object.id }">class="hover"</c:if>><a href="${ctx }/userportal/wapCampDetail.action?id=${objects.id }">·${objects.title }</a></li>
                            		</c:forEach>
                                </ul>
                            </div>
                            </li>
