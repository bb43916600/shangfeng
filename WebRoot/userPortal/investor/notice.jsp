...
<body>
    ...
    <div class="bg_c">
           ...
           <div class="nban">
            ...
            <div class="right">
            	<div class="curr">
                	<span><a href="${ctx }/userportal/wapIndex.action" class="home">首页</a> > <i>公司公告</i></span><h2>公司公告<i>Announcement</i></h2>
                </div>
                <div class="content">
                	<div class="about">
                        ...
                        <ul class="activity_list">
	                        <c:forEach items="${list }" var="object" varStatus="index">
	                        	<li><a href="#"><i>${object.inputTime }</i>${object.title }</a></li>
	                        </c:forEach>
                        </ul>
                         <div class="cls"></div>
                         <!-- 分页开始 -->
            	...
            	<div class="left">
                    ...
                    <div class="sub_m">
                   	  <ul class="sublist">
                        	<li class="hover"><a href="${ctx }/userportal/wapCompanyInfo.action">公司公告</a></li>
