    ...
    <div class="bg_c">
           ...
           <div class="nban">
            ...
            <div class="right">
                ...
                <div class="content">
                	<div class="about dproduct">
                    	<p align="center">
                    		<img src="${ctx }/productImage/${object.images }" width="203" height="198">
                    	</p>
                        <h2>${object.title }</h2>
                        ${object.content }
                    </div>
            	...
            	<div class="left">
                    ...
                    <div class="sub_m">
                   	  <ul class="sublist">
                        	...
                        	<li <c:if test="${object.type eq 2 }">class="hover"</c:if>><a href="${ctx }/userportal/wapProduct.action?type=2">风机产品</a></li>
                            <li <c:if test="${object.type eq 1 }">class="hover"</c:if>><a href="${ctx }/userportal/wapProduct.action?type=1">电磁线产品</a></li>
                        </ul>
