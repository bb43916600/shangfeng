...
<div class="videodiv">
    <div class="video1">
    <img src="${ctx }/userPortal/images/de_honor_pic1.jpg" width="696" height="444" id="imgimg"> 
    ...
    <div class="bg_c">
           ...
           <div class="nban">
            ...
            <div class="right">
            	<div class="curr">
                	<span><a href="${ctx }/userportal/wapIndex.action" class="home">首页</a> > <i>企业荣誉</i></span><h2>企业荣誉<i>Honor</i></h2>
                </div>
                <div class="content">
                	<div class="about">
                    	<ul class="honor_list">
                    		<c:forEach items="${list }" var="object" varStatus="index">
                    			...
                    			<c:if test="${index.count%3 ne 0 }">
                    				<li>
                    			</c:if>
	                    			<a href="javascript:void(0);" class="videogo" rel="${ctx }/honorImage/${object.images}">
	                    			<img src="${ctx }/honorImage/${object.images}">
	                    			<i>${index.count}</i>
	                    			</a>
                    			</li>
                    		</c:forEach>
            	...
            	<div class="left">
                    ...
                    <div class="sub_m">
                   	  <ul class="sublist">
                        	<li><a href="${ctx }/userportal/wapAbout.action">公司概况</a></li>
                            <li class="hover"><a href="${ctx }/userportal/wapHonor.action">企业荣誉</a></li>
                        </ul>
