...
function addObject(){
	...
	$.post("${ctx }/hr/jobContactSave.action",dc.toJSON(),function(response){
		if(response==1){
			alert("提交成功!");
			if(id!=0 && id!=""){
...
<body>
	<div class="right01"><img src="${ctx }/images/04.gif" /> 上风实业 &gt; <span>投资者联系方式设置</span></div>
	<div class="main">
	   <div class="bar"></div>
	   <form id="addObject" method="post">
	   <table width="80%" border="0" cellpadding="0" cellspacing="0" class="table">
	   		<input type="hidden" name="jobContact.id" id="id" value="${jobContact.id }">
	      <tr>
	      	<td width="120" align="right">联系方式:</td>
	      	<td><textarea  class="xheditor" style="width:100%; height: 200px;" id="content" name="jobContact.content" >${jobContact.content }</textarea></td>
	      </tr>
	      <tr>
