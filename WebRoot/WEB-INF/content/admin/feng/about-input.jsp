...
function addObject(){
	...
	$.post("${ctx }/about/aboutSave.action",dc.toJSON(),function(response){
		if(response==1){
			alert("提交成功!");
			if(id!=0 && id!=""){
...
<body>
	<div class="right01"><img src="${ctx }/images/04.gif" /> 上风实业 &gt; <span>概况设置</span></div>
	<div class="main">
	   <div class="bar"></div>
	   <form id="addObject" method="post">
	   <table width="80%" border="0" cellpadding="0" cellspacing="0" class="table">
	   		<input type="hidden" name="about.id" id="id" value="${about.id }">
	      <tr>
	      	<td width="120" align="right">标题:</td>
	      	<td><input type="text" class="inputClass" style="width:300px;" id="title" name="about.title" value="${about.title }" /></td>
	      </tr>
	      <tr>
	      	<td width="120" align="right">内容:</td>
	      	<td><textarea  class="xheditor" style="width:100%; height: 200px;" id="content" name="about.content" >${about.content }</textarea></td>
	      </tr>
	      <tr>
