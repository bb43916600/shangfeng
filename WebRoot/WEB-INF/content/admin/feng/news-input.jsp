...
function addObject(){
	...
	$.post("${ctx }/about/newsSave.action",dc.toJSON(),function(response){
		if(response==1){
			alert("提交成功!");
			$("#title").attr("value","");
			$("#content").val("");
	...
	<div class="main">
	   ...
	   <table width="80%" border="0" cellpadding="0" cellspacing="0" class="table">
	      ...
	      <tr>
	      	...
	      	<td><input type="text" class="inputClass" style="width:300px;" id="title" name="news.title" value="${news.title }" /></td>
	      </tr>
	      <tr>
	      	<td width="120" align="right">内容:</td>
	      	<td><textarea  class="xheditor" style="width:100%; height: 200px;" id="content" name="news.content" >${news.content }</textarea></td>
	      </tr>
	      <tr>
