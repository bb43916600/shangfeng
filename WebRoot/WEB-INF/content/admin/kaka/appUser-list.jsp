...
<script type="text/javascript">
	$(document).ready(function() {
		$("#gridTable").jqGrid({
			url: "${ctx}/appUser/objectList.action",
	   		datatype: "json",
	   		mtype: "post",
	    	...
	    	colModel: [ 
				...
				{name:'state',index:'cn_content', width:40,align:"center"},
	...
	function doUpdate(id){
		...
		diag.Title = "编辑";
		diag.URL = "${ctx}/appUser/objectInput.action?id="+id;
		diag.show();
	}
...
<body>
	<div class="right01"><img src="${ctx}/images/04.gif" /> 卡卡叫车系统 &gt; <span>查询司机</span></div>
	<div class="main">
   <div class="bar">
