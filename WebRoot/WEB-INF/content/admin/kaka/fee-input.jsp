...
function addObject(){
	...
	$.post("${ctx }/fee/objectSave.action",dc.toJSON(),function(response){
		if(response==1){
			alert("提交成功!");
		}else{
			alert("操作有误!");
...
<body>
	...
	<div class="main">
	   ...
	   <table width="80%" border="0" cellpadding="0" cellspacing="0" class="table">
	   		<input type="hidden" name="fee.id" id="id" value="${fee.id }">
	      <tr>
	      	<td width="120" align="right">费用说明(繁体):</td>
	      	<td><textarea  class="xheditor" style="width:800px; height: 200px;" id="ct_areaName" name="fee.ct_content" >${fee.ct_content }</textarea></td>
	      </tr>
	      <tr>
	      	<td width="120" align="right">费用说明(英文):</td>
	      	<td><textarea  class="xheditor" style="width:800px; height: 200px;" id="en_areaName" name="fee.en_content" >${fee.en_content }</textarea></td>
	      </tr>
	      <tr>
	      	<td width="120" align="right">费用说明(简体):</td>
	      	<td><textarea  class="xheditor" style="width:800px; height: 200px;" id="cn_areaName" name="fee.cn_content" >${fee.cn_content }</textarea></td>
	      </tr>
	      <tr>
