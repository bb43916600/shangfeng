	...
	' + (function (obj) {
        ...
        return "";
          ...
          <tr id="_ButtonRow_{thisID}" style="' + (this.ShowButtonRow ? "" : "display:none") + '">\
            <td height="36"><div id="_DialogButtons_{thisID}" style="border-top: 1px solid #DADEE5; padding: 6px 20px 0px 20px; text-align: right; background-color:#f6f6f6;">\
			    <a href="javascript:void 0" class="btn_azul" id="_ButtonCancel_{thisID}" onclick="Dialog.getInstance(\'{thisID}\').close();" style="float:right;margin-bottom:6px;">'+this.CancelButtonText+'</a>\
				<a href="javascript:void 0" class="btn_azul" id="_ButtonOK_{thisID}" style="float:right;margin-bottom:6px;margin-right:10px;">'+this.OkButtonText+'</a>\
				<div class="clear"></div>\
              </div></td>\
          </tr>\
        </table></td>\
    ...
    if (this.URL) {
        ...
        this.innerFrameOnload = function () {
            ...
            try {
                ...
                if (window.console && window.console.log) console.log("Can not get the document object of float window, maybe you have not the rights of access.");
...
Dialog.prototype.autoClose = function () {
    ...
    this.AutoClose -= 1;
    topWin.getDom("_Title_" + this.ID).innerHTML = "Auto closed after " + this.AutoClose + " seconds";
    if (this.AutoClose <= 0) {
        this.close();
    } else {
        var self = this;
...
Dialog.getInstance = function (id) {
    ...
    if (!dialogDiv) alert("Can not get the object ID of dialog page!");
	try{
...
Dialog.prototype.getDialogDiv = function () {
	...
	if(!dialogDiv)alert("Get the element object of dialog page error!");
	try{
		return dialogDiv;
	}finally{
		dialogDiv = null;
